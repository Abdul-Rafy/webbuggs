      ...
      if(action === 'init'){
        ...
        templateParts.forEach(function(part, index){
          ...
          if(typeof labelsArray[index] !== 'undefined'){
            if(part === 'dd' || part === 'ddd'){
              $part.append('<p class="et_pb_with_border flipper-label flipper-label-days label">' + labelsArray[index] + '</p>');
            }
            if(part === 'HH'){
              $part.append('<p class="et_pb_with_border flipper-label flipper-label-hours label">' + labelsArray[index] + '</p>');    
            }
            if(part === 'ii'){
              $part.append('<p class="et_pb_with_border flipper-label flipper-label-minutes label">' + labelsArray[index] + '</p>'); 
            }

            if(part === 'ss'){
              $part.append('<p class="et_pb_with_border flipper-label flipper-label-seconds label">' + labelsArray[index] + '</p>'); 
            }
